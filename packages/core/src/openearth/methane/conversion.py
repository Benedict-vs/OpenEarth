...
The LUT (``methane/data/ch4_lut_v1.npz``) is generated offline by
...
def load_lut(path: Path | None = None) -> CH4Lut:
    """Load the CH4 LUT (cached). *path* defaults to the packaged ``ch4_lut_v1.npz``."""
