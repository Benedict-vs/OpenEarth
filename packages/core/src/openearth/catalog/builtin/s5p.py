"""Built-in Sentinel-5P/TROPOMI trace-gas products (GEE L3 grids).

The COPERNICUS/S5P/OFFL/L3_* collections are already QA-screened upstream
(harpconvert qa_value filtering per product); the v2 provider additionally
masks values outside each product's physically valid range.
"""
...
S5P_PRODUCTS: dict[str, ProductSpec] = {
    "NO2": ProductSpec(
        key="NO2",
        name="Nitrogen Dioxide",
        collection_id="COPERNICUS/S5P/OFFL/L3_NO2",
        source_band="tropospheric_NO2_column_number_density",
        vis_min=0.0,
        vis_max=0.0003,
        valid_min=-0.0001,
        valid_max=0.001,
    ...
    "SO2": ProductSpec(
        ...
        source_band="SO2_column_number_density",
        vis_min=0.0,
        vis_max=0.0005,
        valid_min=-0.001,
        valid_max=0.01,
    ...
    "CO": ProductSpec(
        ...
        source_band="CO_column_number_density",
        vis_min=0.0,
        vis_max=0.05,
        valid_min=0.0,
        valid_max=0.1,
    ...
    "O3": ProductSpec(
        ...
        source_band="O3_column_number_density",
        vis_min=0.07,
        vis_max=0.20,
        valid_min=0.0,
        valid_max=0.3,
    ...
    "CH4": ProductSpec(
        ...
        source_band=("CH4_column_volume_mixing_ratio_dry_air_bias_corrected"),
        vis_min=1750.0,
        vis_max=2000.0,
        valid_min=1600.0,
        valid_max=2200.0,
    ...
    "HCHO": ProductSpec(
        ...
        source_band=("tropospheric_HCHO_column_number_density"),
        vis_min=0.0,
        vis_max=0.0005,
        valid_min=-0.0005,
        valid_max=0.005,
...
S5P_DATASET = DatasetSpec(
    id="s5p",
    title="Sentinel-5P TROPOMI (L3)",
    collection_id="COPERNICUS/S5P/OFFL/L3_NO2",
    attribution="Google Earth Engine / Copernicus Sentinel-5P",
